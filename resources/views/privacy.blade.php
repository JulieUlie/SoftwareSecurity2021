...
<div class="container ">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card p-5">
<h3 style="text-align: center;">julietous.be Privacy Policy</h3>
<p>Julietous.be is a personal website used for educational purposes. This privacy policy will explain how our organization uses the personal data we collect from you when you use our website.</p>
<p>Topics:</p>
<ul>
...
<ul>
    ...
    <li>Generate a personal access token or OAUTH2 client.</li>
    <li>Voluntarily submitting content such as tweets</li>
</ul>
<h3>How will we use your data?</h3>
<p>Our Company collects your data so that we can:</p>
<ul>
    <li>Display Tweets with username included.</li>
    <li>Email you a confirmation email.</li>
</ul>
...
<p>Our Company securely stores your data in a MySQL Database at a DigitalOcean datacentre in New York City.</p>
<p>Our Company will keep all your data indefinitely or until the site gets deleted.</p>
...
<p>If you make a request, we have one month to respond to you. If you would like to exercise any of these rights, please contact us at our email:julietous@outlook.com</p>
<h3>Cookies</h3>
...
<p>Our Company uses cookies only to store session data, including:</p>
<ul>
...
<p>Email us at:julietous@outlook.com</p>
